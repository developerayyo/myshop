"""
Django settings for TronicStore project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'shop.context_processors.tawk_processor',
...
WSGI_APPLICATION = 'TronicStore.wsgi.application'
